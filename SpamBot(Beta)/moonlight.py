...
{Fore.RED}              
 ...
 ██║╚██╔╝██║██║   ██║██║   ██║██║╚██╗██║██║     ██║██║   ██║██╔══██║   ██║   
 ██║ ╚═╝ ██║╚██████╔╝╚██████╔╝██║ ╚████║███████╗██║╚██████╔╝██║  ██║   ██║   
 ╚═╝     ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝╚══════╝╚═╝ ╚═════╝ ╚═╝  ╚═╝   ╚═╝    {Fore.MAGENTA} Made by:{Fore.RED} Zer0{Fore.MAGENTA}
      {Fore.RED} Discord:{Fore.GREEN} z3r0d4y#0074 {Fore.MAGENTA}|{Fore.RED} IG:{Fore.GREEN} soon... {Fore.MAGENTA}|{Fore.RED} GitHub: {Fore.GREEN}soon...

 {Fore.RED}[{Fore.MAGENTA}1{Fore.RED}]{Fore.GREEN} SMS Bomb (beta)
